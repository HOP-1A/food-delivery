      ...
      <div className="w-4/6">
        <div className="flex justify-between pb-4">
          ...
          <div className="flex gap-4">
            <div className="flex bg-green-700 rounded-md text-white p-2 gap-2 font-bold hover:cursor-pointer">
              <CirclePlus />
        ...
        <div className="flex justify-between mt-8 mb-8">
          <div className="flex bg-amber-950 rounded-md text-white p-2 gap-2 hover:cursor-pointer">
            <ArrowLeft />
            <div>Өмнөх алхам руу буцах</div>
          </div>
          <div className="flex bg-red-600 rounded-md text-white p-2 gap-2 hover:cursor-pointer">
            <div>Үргэлжүүлэх</div>
            <ArrowRight />
          </div>
        </div>
